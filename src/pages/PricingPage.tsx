...
const TIERS: TierCard[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'PDF sans marque + logo personnalisé',
      'Export DGI mensuel automatique',
      'Relances email automatiques (J+3, J+7, J+15)',
      'Paiement Wave / Orange Money / MTN intégré',
      'Tableau de bord (CA, impayés, top clients)',
      'Historique illimité + sauvegarde quotidienne',
  ...
  },
  {
    ...
    features: [
      ...
      'Utilisateurs illimités + rôles personnalisés',
      'Intégration à vos outils via API REST',
