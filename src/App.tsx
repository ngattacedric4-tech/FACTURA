...
function AppContent() {
  ...
  // Activation gate — bloque si kill switch ON + clé absente/expirée
  if (!activation.loading && !activation.activated) {
    return <ActivationPage onActivated={activation.refresh} />;
  }
